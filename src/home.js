...
const Home = ({title,description}) => {
  ...
  return (
    <>
      <div>
        <p className="bar">🚀 Looking to hire a Full Stack Developer? Please review my&nbsp;<a href="https://feji.us/b1koin" target="_blank">resume</a>&nbsp;and projects. 🚀</p>
      </div>
      <div className="nav">
      ...
      <div className="main">
        <div id="home" className="section text">
          ...
          <div className="buttons">
            <button className="project-btn"><a href="#project">PROJECTS &lt;/&gt;</a></button>
        ...
        <div id="experience" className="section experience-section">
          ...
          <div className="experience-container">
            <div className="experience-box">
              <h2 className="experience-time">May 2023 - July 2023</h2>
          ...
          <div className="experience-box">
          <h2 className="experience-time">April 2024 - July 2024</h2>
              <h3 className="experience-role">Website Development</h3>
              <h3 className="experience-company">Freelancer</h3>
              <p className="company-desc">MLBT School wanted to increase student engagement and communication with parents. They needed a digital platform for resources and collaboration.</p>
              <ul className="experience-list">
                <li>Devloped an engaging website for MLBT School with React.js & BootStrap, enhancing digital representation through interactive features, 
                which led to increase in social media shares and improved community visibility for the school's program.
                </li> 
                <li>In this website we showcase the activities, achievements and vision and mission of the school.
                </li>
              </ul>
          </div>
  ...
  <div className="footer-top">
    ...
    <div className="social-links">
      <a href="19chanduvarma@gmail.com"><img src="https://img.icons8.com/color/48/000000/gmail--v1.png" alt="Gmail" /></a>
      ...
      <a href="https://www.linkedin.com/in/chandu-varma-b97535249/" target="_blank" rel="noopener noreferrer"><img src="https://img.icons8.com/color/48/000000/linkedin.png" alt="LinkedIn" /></a>
      <a href="https://github.com/chandu1903" target="_blank" rel="noopener noreferrer"><img src="https://img.icons8.com/material-outlined/48/000000/github.png" alt="GitHub" /></a>
    </div>
    </div>
  </div>

  <div className="footer-bottom">
    <p className="a">Find an issue with this page? <a href="https://github.com/chandu1903" target="_blank" rel="noopener noreferrer">Fix it on GitHub</a></p>
    <p className="b">Created with &nbsp;<span role="img" aria-label="heart"> <img src={react} className="footer-bottom-logo"/> </span> &nbsp; by &nbsp;<a href="https://www.linkedin.com/in/chandu-varma-b97535249/" target="_blank" rel="noopener noreferrer">  Chandu</a></p>
  </div>
</footer>
        </div>
    </>
